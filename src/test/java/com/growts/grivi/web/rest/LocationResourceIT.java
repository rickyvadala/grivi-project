...
import com.growts.grivi.domain.Location;
import com.growts.grivi.repository.LocationRepository;
...
public class LocationResourceIT {
    ...
    private static final Long DEFAULT_STREET_NUMBER = 1L;
    private static final Long UPDATED_STREET_NUMBER = 2L;
    ...
    public void getAllLocations() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].streetNumber").value(hasItem(DEFAULT_STREET_NUMBER.intValue())))
    ...
    public void getLocation() throws Exception {
        ...
        restLocationMockMvc.perform(get("/api/locations/{id}", location.getId()))
            ...
            .andExpect(jsonPath("$.streetNumber").value(DEFAULT_STREET_NUMBER.intValue()))
