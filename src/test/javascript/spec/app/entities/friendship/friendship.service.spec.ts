...
import { Friendship } from '@/shared/model/friendship.model';
...
describe('Service Tests', () => {
  describe('Friendship Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should update a Friendship', async () => {
        const returnedFromService = Object.assign({}, elemDefault);
      ...
      it('should not update a Friendship', async () => {
      ...
      it('should not return a list of Friendship', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
