...
import { Reaction } from '@/shared/model/reaction.model';
...
describe('Service Tests', () => {
  describe('Reaction Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Reaction(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should not update a Reaction', async () => {
      ...
      it('should return a list of Reaction', async () => {
        const returnedFromService = Object.assign(
          {
            type: 'BBBBBB',
          },
      ...
      it('should not return a list of Reaction', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
