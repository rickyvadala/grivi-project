...
describe('Service Tests', () => {
  describe('Channel Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should not create a Channel', async () => {
      ...
      it('should not update a Channel', async () => {
      ...
      it('should not return a list of Channel', async () => {
        mockedAxios.get.mockReturnValue(Promise.reject(error));
      ...
      it('should not delete a Channel', async () => {
