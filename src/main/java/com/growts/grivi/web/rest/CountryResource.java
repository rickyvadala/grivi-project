...
import com.growts.grivi.domain.Country;
import com.growts.grivi.repository.CountryRepository;
...
/**
 * REST controller for managing {@link com.growts.grivi.domain.Country}.
 */
@RestController
@RequestMapping("/api")
@Transactional
