...
import com.growts.grivi.domain.Category;
import com.growts.grivi.repository.CategoryRepository;
...
/**
 * REST controller for managing {@link com.growts.grivi.domain.Category}.
 */
@RestController
@RequestMapping("/api")
@Transactional
