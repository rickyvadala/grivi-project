...
import com.growts.grivi.domain.Comment;
import com.growts.grivi.repository.CommentRepository;
...
/**
 * REST controller for managing {@link com.growts.grivi.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
@Transactional
