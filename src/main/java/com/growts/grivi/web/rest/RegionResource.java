...
import com.growts.grivi.domain.Region;
import com.growts.grivi.repository.RegionRepository;
...
/**
 * REST controller for managing {@link com.growts.grivi.domain.Region}.
 */
@RestController
@RequestMapping("/api")
@Transactional
