...
import com.growts.grivi.domain.Question;
import com.growts.grivi.repository.QuestionRepository;
...
/**
 * REST controller for managing {@link com.growts.grivi.domain.Question}.
 */
@RestController
@RequestMapping("/api")
@Transactional
