...
import com.growts.grivi.domain.Department;
import com.growts.grivi.repository.DepartmentRepository;
...
/**
 * REST controller for managing {@link com.growts.grivi.domain.Department}.
 */
@RestController
@RequestMapping("/api")
@Transactional
