<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('griviApp.company.home.title')" id="company-heading">Companies</span>
            <router-link :to="{name: 'CompanyCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-company">
                ...
                <span  v-text="$t('griviApp.company.home.createLabel')">
        ...
        <div class="alert alert-warning" v-if="!isFetching && companies && companies.length === 0">
            <span v-text="$t('griviApp.company.home.notFound')">No companies found</span>
        </div>
        <div class="table-responsive" v-if="companies && companies.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('griviApp.company.name')">Name</span></th>
                    <th><span v-text="$t('griviApp.company.description')">Description</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="griviApp.company.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-company-heading" v-text="$t('griviApp.company.delete.question', {'id': removeId})">Are you sure you want to delete this Company?</p>
            </div>
