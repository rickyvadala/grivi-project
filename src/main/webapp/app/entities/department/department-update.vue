    ...
    <div class="row justify-content-center">
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                <h2 id="griviApp.department.home.createOrEditLabel" v-text="$t('griviApp.department.home.createOrEditLabel')">Create or edit a Department</h2>
                <div>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('griviApp.department.departmentName')" for="department-departmentName">Department Name</label>
                    ...
                    <div class="form-group">
                        <label class="form-control-label" v-text="$t('griviApp.department.location')" for="department-location">Location</label>
